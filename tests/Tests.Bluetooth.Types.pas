...
type
  ...
  public
    ...
    // ConnectionStateText tests
    [Test]
    procedure ConnectionStateText_Disconnected;
    [Test]
    procedure ConnectionStateText_Connected;
    [Test]
    procedure ConnectionStateText_Connecting;
    [Test]
    procedure ConnectionStateText_Disconnecting;
    [Test]
    procedure ConnectionStateText_Error;
    [Test]
    procedure ConnectionStateText_Unknown;

    // DeviceTypeText tests
    [Test]
    procedure DeviceTypeText_AudioOutput;
    [Test]
    procedure DeviceTypeText_AudioInput;
    [Test]
    procedure DeviceTypeText_Headset;
    [Test]
    procedure DeviceTypeText_Keyboard;
    [Test]
    procedure DeviceTypeText_Mouse;
    [Test]
    procedure DeviceTypeText_Gamepad;
    [Test]
    procedure DeviceTypeText_HID;
    [Test]
    procedure DeviceTypeText_Unknown;
...
procedure TBluetoothDeviceInfoTests.ConnectionStateText_Disconnected;
var
  Device: TBluetoothDeviceInfo;
begin
  Device := CreateTestDevice(btAudioOutput, csDisconnected);
  Assert.AreEqual('Disconnected', Device.ConnectionStateText);
end;

procedure TBluetoothDeviceInfoTests.ConnectionStateText_Connected;
var
  Device: TBluetoothDeviceInfo;
begin
  Device := CreateTestDevice(btAudioOutput, csConnected);
  Assert.AreEqual('Connected', Device.ConnectionStateText);
end;

procedure TBluetoothDeviceInfoTests.ConnectionStateText_Connecting;
var
  Device: TBluetoothDeviceInfo;
begin
  Device := CreateTestDevice(btAudioOutput, csConnecting);
  Assert.AreEqual('Connecting...', Device.ConnectionStateText);
end;

procedure TBluetoothDeviceInfoTests.ConnectionStateText_Disconnecting;
var
  Device: TBluetoothDeviceInfo;
begin
  Device := CreateTestDevice(btAudioOutput, csDisconnecting);
  Assert.AreEqual('Disconnecting...', Device.ConnectionStateText);
end;

procedure TBluetoothDeviceInfoTests.ConnectionStateText_Error;
var
  Device: TBluetoothDeviceInfo;
begin
  Device := CreateTestDevice(btAudioOutput, csError);
  Assert.AreEqual('Error', Device.ConnectionStateText);
end;

procedure TBluetoothDeviceInfoTests.ConnectionStateText_Unknown;
var
  Device: TBluetoothDeviceInfo;
begin
  Device := CreateTestDevice(btAudioOutput, csUnknown);
  Assert.AreEqual('Unknown', Device.ConnectionStateText);
end;

procedure TBluetoothDeviceInfoTests.DeviceTypeText_AudioOutput;
var
  Device: TBluetoothDeviceInfo;
begin
  Device := CreateTestDevice(btAudioOutput, csDisconnected);
  Assert.AreEqual('Audio Output', Device.DeviceTypeText);
end;

procedure TBluetoothDeviceInfoTests.DeviceTypeText_AudioInput;
var
  Device: TBluetoothDeviceInfo;
begin
  Device := CreateTestDevice(btAudioInput, csDisconnected);
  Assert.AreEqual('Audio Input', Device.DeviceTypeText);
end;

procedure TBluetoothDeviceInfoTests.DeviceTypeText_Headset;
var
  Device: TBluetoothDeviceInfo;
begin
  Device := CreateTestDevice(btHeadset, csDisconnected);
  Assert.AreEqual('Headset', Device.DeviceTypeText);
end;

procedure TBluetoothDeviceInfoTests.DeviceTypeText_Keyboard;
var
  Device: TBluetoothDeviceInfo;
begin
  Device := CreateTestDevice(btKeyboard, csDisconnected);
  Assert.AreEqual('Keyboard', Device.DeviceTypeText);
end;

procedure TBluetoothDeviceInfoTests.DeviceTypeText_Mouse;
var
  Device: TBluetoothDeviceInfo;
begin
  Device := CreateTestDevice(btMouse, csDisconnected);
  Assert.AreEqual('Mouse', Device.DeviceTypeText);
end;

procedure TBluetoothDeviceInfoTests.DeviceTypeText_Gamepad;
var
  Device: TBluetoothDeviceInfo;
begin
  Device := CreateTestDevice(btGamepad, csDisconnected);
  Assert.AreEqual('Gamepad', Device.DeviceTypeText);
end;

procedure TBluetoothDeviceInfoTests.DeviceTypeText_HID;
var
  Device: TBluetoothDeviceInfo;
begin
  Device := CreateTestDevice(btHID, csDisconnected);
  Assert.AreEqual('Input Device', Device.DeviceTypeText);
end;

procedure TBluetoothDeviceInfoTests.DeviceTypeText_Unknown;
var
  Device: TBluetoothDeviceInfo;
begin
  Device := CreateTestDevice(btUnknown, csDisconnected);
  Assert.AreEqual('Unknown', Device.DeviceTypeText);
end;
